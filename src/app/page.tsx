      ...
      <main className="container mx-auto px-4 py-16">
        ...
        <section className="text-center space-y-6 mb-20">
          ...
          <div className="pt-4">
            <Link
              href="/login"
              className="inline-block px-8 py-4 bg-blue-600 dark:bg-blue-500 text-white text-lg font-semibold rounded-lg hover:bg-blue-700 dark:hover:bg-blue-600 transition-colors shadow-lg"
            >
              無料で始める
            </Link>
          </div>
